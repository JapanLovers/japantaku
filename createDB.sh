...
echo 'DOING rails generate model user email:email:uniq pseudo:string:uniq desc:text age:integer avatar_name:string last_name:string first_name:string pwd:string is_admin:boolean'
rails generate model User email:email:uniq pseudo:string:uniq desc:text age:integer avatar_name:string last_name:string first_name:string pwd:string is_admin:boolean
