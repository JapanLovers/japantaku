...
echo 'DOING rails generate model Comment content:text pseudo:string'
rails generate model Comment content:text pseudo:string
echo 'DOING rails generate model Article title:string:uniq date:datetime content:string'
rails generate model Article title:string:uniq date:datetime content:string
echo 'DOING rails generate model User email:string:uniq pseudo:string:uniq desc:string age:integer avatar:string last_name:string first_name:string pwd:string admin:boolean'
